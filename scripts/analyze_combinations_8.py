...
if not os.path.exists(DATA_PATH):
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            comb = combinations(sorted(numbers), 8)
        ...
        output_file = os.path.join("output", "most_common_8_combinations.csv")
        os.makedirs("output", exist_ok=True)
        result_df.to_csv(output_file, index=False)

        print("✅ Οι πιο συχνές 8άδες υπολογίστηκαν και αποθηκεύτηκαν!")
        print(result_df)
